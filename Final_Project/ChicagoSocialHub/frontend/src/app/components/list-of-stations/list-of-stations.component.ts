...
export class ListOfStationsComponent implements OnInit {
  ...
  displayedColumns = ['id', 'stationName', 'availableBikes', 'availableDocks', 'is_renting', 'lastCommunicationTime', 'latitude',  'longitude', 'status', 'totalDocks','realTime'];
  ...
  go_to_live(id){    
    this.router.navigate(['/realTime'],{  queryParams: {id: id  }})
  }
